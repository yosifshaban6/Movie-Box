    ...
    <Container className="py-4">
      ...
      {hasFavorites ? (
              ...
              <Row>
                {favoriteMovies.map(movie => (
                  <Col key={movie.id} md={12} className="mb-4">
                    <MoviesCard movie={movie} page="favorites" layout="horizontal" />
                  </Col>
                ))}
              </Row>
            </>
              ...
              <Row>
                {favoriteSeries.map(series => (
                  <Col key={series.id} md={12} className="mb-4">
                    <SeriesCard show={series} page="favorites" layout="horizontal" />
                  </Col>
                ))}
              </Row>
            </>
        ...
        <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '60vh' }}>
          <img src="/no-favorite.jpg" alt="No favorites" className="mb-4" style={{ maxWidth: '100%', height: 'auto' }} />
